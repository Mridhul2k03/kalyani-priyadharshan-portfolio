            ...
            <div className="relative z-10 container mx-auto px-4 py-20 text-center">
                <Reveal>
                    <div className="inline-block relative">
                        <h1 className="text-5xl md:text-8xl font-black tracking-tighter mb-4 text-transparent bg-clip-text bg-gradient-to-r from-white via-primary to-white">
                            FILMOGRAPHY
                        </h1>
                        <div className="absolute -inset-1 bg-primary/20 blur-xl -z-10 animate-pulse" />
                    </div>
                    <p className="text-xl text-gray-400 max-w-2xl mx-auto mt-6 font-light tracking-wide">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {films.map((film, index) => (
                        <Reveal key={index} delay={index * 100} className="h-full">
                            <Link
                                to={`/films/${film.id}`}
                                className="group relative bg-gray-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden hover:border-primary/50 transition-all duration-500 hover:shadow-[0_0_30px_rgba(236,72,153,0.3)] block h-full flex flex-col"
                            >
                                {/* Video Container */}
                                ...
                                <div className="p-6 relative flex flex-col grow">
                                    ...
                                    <p className="text-gray-400 text-sm line-clamp-3 mb-4 leading-relaxed grow">
                                        {film.description}
                                    </p>

                                    <div className="flex items-center gap-4 text-xs text-gray-500 uppercase tracking-widest font-semibold mt-auto">
